...
def create_from_images(tfrecord_dir, image_dir, shuffle, add_condition):
    ...
    all_data = unpickle('/content/ConditionalStyleGAN/data/mypickle.pickle')
...
# image_dir = 'C:/Users/evane/Documents/GitHub/ConditionalStyleGAN/data/Conditional_StyleGAN_Logo/'
# tfrecord_dir = 'C:/Users/evane/Documents/GitHub/ConditionalStyleGAN/dataset/logos'
